...
Ce système Foundry VTT est une implémentation technique du système **Stellaire D6**, basé sur les règles allégées créées par **Elostiragn**, et utilisé pour jouer **La Campagne Stellaire**, créée par **Bayross**.
